...
NEWTON = _pyRVO.NEWTON
LBFGS = _pyRVO.LBFGS
UNKNOWN = _pyRVO.UNKNOWN
class RVOSimulator(object):
    ...
    def getMaxRadius(self):
        return _pyRVO.RVOSimulator_getMaxRadius(self)
    ...
    def getAgentRadius(self, i):
        return _pyRVO.RVOSimulator_getAgentRadius(self, i)

    def addAgent(self, pos, vel, rad):
        return _pyRVO.RVOSimulator_addAgent(self, pos, vel, rad)
    ...
    def setLBFGSParameter(self, nrCorrect=5):
        return _pyRVO.RVOSimulator_setLBFGSParameter(self, nrCorrect)
...
class MultiRVOSimulator(object):
    ...
    def __init__(self, *args):
        _pyRVO.MultiRVOSimulator_swiginit(self, _pyRVO.new_MultiRVOSimulator(*args))
    ...
    def addAgent(self, pos, vel, rad):
        return _pyRVO.MultiRVOSimulator_addAgent(self, pos, vel, rad)
...
class RVOVisualizer(object):
    ...
    @staticmethod
    def drawQuad(_from, to, color):
        return _pyRVO.RVOVisualizer_drawQuad(_from, to, color)

    @staticmethod
    def drawLine(_from, to, color):
        return _pyRVO.RVOVisualizer_drawLine(_from, to, color)

    @staticmethod
    def clearQuad():
        return _pyRVO.RVOVisualizer_clearQuad()

    @staticmethod
    def clearLine():
        return _pyRVO.RVOVisualizer_clearLine()

    @staticmethod
    def drawRVO(*args):
        return _pyRVO.RVOVisualizer_drawRVO(*args)

    def __init__(self):
        _pyRVO.RVOVisualizer_swiginit(self, _pyRVO.new_RVOVisualizer())
    __swig_destroy__ = _pyRVO.delete_RVOVisualizer

# Register RVOVisualizer in _pyRVO:
_pyRVO.RVOVisualizer_swigregister(RVOVisualizer)

def RVOVisualizer_drawQuad(_from, to, color):
    return _pyRVO.RVOVisualizer_drawQuad(_from, to, color)

def RVOVisualizer_drawLine(_from, to, color):
    return _pyRVO.RVOVisualizer_drawLine(_from, to, color)

def RVOVisualizer_clearQuad():
    return _pyRVO.RVOVisualizer_clearQuad()

def RVOVisualizer_clearLine():
    return _pyRVO.RVOVisualizer_clearLine()

def RVOVisualizer_drawRVO(*args):
    return _pyRVO.RVOVisualizer_drawRVO(*args)

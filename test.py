...
def train():
    ...
    print_freq = max_ep_len * 400        # print avg reward in the interval (in num timesteps)
    log_freq = max_ep_len * 80           # log avg reward in the interval (in num timesteps)
    save_model_freq = int(6e5)          # save model frequency (in num timesteps) 4
    ...
    action_std_decay_freq = int(6e5)    # action_std decay frequency (in num timesteps)
    #####################################################

    ## Note : print/log frequencies should be > than max_ep_len

    ################ PPO hyperparameters ################
    update_timestep = max_ep_len * 200      # update policy every n timesteps
